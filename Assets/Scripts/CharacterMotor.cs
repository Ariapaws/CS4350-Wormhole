...
public class CharacterMotor : MonoBehaviour
{
	...
	private void UpdateFunction()
	{
		...
		// START TEST FLYING FIX
		if(movement.velocity.y > 7){
			Debug.Log ("Flying! FLYING FLYING FLYING FLYING FLYING");
			Debug.Log ("Position: "+ tr.position.ToString());
			movement.velocity.y = -5.0f;
		}
		// STOP TEST FLYING FIX
